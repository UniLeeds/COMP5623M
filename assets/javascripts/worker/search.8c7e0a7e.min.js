! function(e) {
     ...
     */
    ! function() {
        var s, o, a, u, l, c, h, d, f, p, y, m, g, x, v, w, Q, S, b, k, E, L, P, T, O, R, I = function(e) {
            var t = new I.Builder;
        ...
        I.version = "2.3.9"
             ...
             * Copyright (C) 2020 Oliver Nightingale
             */
            , I.utils = {}, I.utils.warn = (s = this, function(e) {
            ...
            , I.stemmer = (o = {
                ...
                ful: "",
                ness: ""
            }, u = "[aeiouy]", l = "[^aeiou][^aeiouy]*", c = new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*"), h = new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*[aeiouy][aeiou]*[^aeiou][^aeiouy]*"), d = new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*([aeiouy][aeiou]*)?$"), f = new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy]"), p = /^(.+?)(ss|i)es$/, y = /^(.+?)([^s])s$/, m = /^(.+?)eed$/, g = /^(.+?)(ed|ing)$/, x = /.$/, v = /(at|bl|iz)$/, w = new RegExp("([^aeiouylsz])\\1$"), Q = new RegExp("^" + l + u + "[^aeiouwxy]$"), S = /^(.+?[^aeiou])y$/, b = /^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/, k = /^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/, E = /^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/, L = /^(.+?)(s|t)(ion)$/, P = /^(.+?)e$/, T = /ll$/, O = new RegExp("^" + l + u + "[^aeiouwxy]$"), R = function(e) {
                var t, r, n, i, s, u, l;
                ...
                } else s.test(e) && (t = (R = s.exec(e))[1], (s = f).test(t) && (u = w, l = Q, (s = v).test(e = t) ? e += "e" : u.test(e) ? (i = x, e = e.replace(i, "")) : l.test(e) && (e += "e")));
                return (i = S).test(e) && (e = (t = (R = i.exec(e))[1]) + "i"), (i = b).test(e) && (t = (R = i.exec(e))[1], r = R[2], (i = c).test(t) && (e = t + o[r])), (i = k).test(e) && (t = (R = i.exec(e))[1], r = R[2], (i = c).test(t) && (e = t + a[r])), s = L, (i = E).test(e) ? (t = (R = i.exec(e))[1], (i = h).test(t) && (e = t)) : s.test(e) && (t = (R = s.exec(e))[1] + R[2], (s = h).test(t) && (e = t)), (i = P).test(e) && (t = (R = i.exec(e))[1], s = d, u = O, ((i = h).test(t) || s.test(t) && !u.test(t)) && (e = t)), s = h, (i = T).test(e) && s.test(e) && (i = x, e = e.replace(i, "")), "y" == n && (e = n.toLowerCase() + e.substr(1)), e
            }, function(e) {
                return e.update(R)
            ...
            , I.TokenSet = function() {
                ...
                for (var r = new I.TokenSet, n = [{
                    ...
                    if (i.str.length > 0) {
                        ...
                        o in i.node.edges ? s = i.node.edges[o] : (s = new I.TokenSet, i.node.edges[o] = s), 1 == i.str.length && (s.final = !0), n.push({
                            node: s,
                    ...
                    if (0 != i.editsRemaining) {
                        ...
                        if (i.str.length > 1) {
                            var l, c = i.str.charAt(0),
                                h = i.str.charAt(1);
                            h in i.node.edges ? l = i.node.edges[h] : (l = new I.TokenSet, i.node.edges[h] = l), 1 == i.str.length && (l.final = !0), n.push({
                                node: l,
                                editsRemaining: i.editsRemaining - 1,
                                str: c + i.str.slice(2)
                            })
                ...
                for (var t = new I.TokenSet, r = void 0, n = [{
                        qNode: e,
                        output: t,
                        node: this
                    }]; n.length;) {
                        ...
                        for (var l = i[u], c = 0; c < a; c++) {
                            ...
                            if (h == l || "*" == l) {
                                var d = r.node.edges[h],
                                    ...
                                    p = d.final && f.final,
                                    y = void 0;
                                h in r.output.edges ? (y = r.output.edges[h]).final = y.final || p : ((y = new I.TokenSet).final = p, r.output.edges[h] = y), n.push({
                                    qNode: f,
                                    output: y,
                                    node: d
                                })
            ...
            , I.Index = function(e) {
                ...
                for (var t = new I.Query(this.fields), r = Object.create(null), n = Object.create(null), i = Object.create(null), s = Object.create(null), o = Object.create(null), a = 0; a < this.fields.length; a++) n[this.fields[a]] = new I.Vector;
                e.call(t, t);
                        ...
                        for (var m = 0; m < p.length; m++) {
                            ...
                            for (y = 0; y < u.fields.length; y++) {
                                var w = x[j = u.fields[y]],
                                    ...
                                    S = g + "/" + j,
                                    b = new I.Set(Q);
                                if (u.presence == I.Query.presence.REQUIRED && (c = c.union(b), void 0 === s[j] && (s[j] = I.Set.complete)), u.presence != I.Query.presence.PROHIBITED) {
                                    if (n[j].upsert(v, u.boost, (function(e, t) {
                                            return e + t
                                        })), !i[S]) {
                                        for (var k = 0; k < Q.length; k++) {
                                            var E, L = Q[k],
                                                ...
                                                T = w[L];
                                            void 0 === (E = r[P]) ? r[P] = new I.MatchData(g, j, T) : E.add(g, j, T)
                                        }
                                        i[S] = !0
                                    }
                                } else void 0 === o[j] && (o[j] = I.Set.empty), o[j] = o[j].union(b)
                            }
                        }
                    }
                ...
                for (a = 0; a < this.fields.length; a++) {
                    var j;
                    s[j = this.fields[a]] && (O = O.intersect(s[j])), o[j] && (R = R.union(o[j]))
                }
                var F = Object.keys(r),
                    C = [],
                ...
                for (a = 0; a < F.length; a++) {
                    ...
                    if (O.contains(D) && !R.contains(D)) {
                        var A, B = this.fieldVectors[N],
                            $ = n[N.fieldName].similarity(B);
                        if (void 0 !== (A = _[D])) A.score += $, A.matchData.combine(r[N]);
                        else {
                            var z = {
                                ref: D,
                                score: $,
                ...
                return o.finish(), t.fields = e.fields, t.fieldVectors = r, t.invertedIndex = i, t.tokenSet = o.root, t.pipeline = a, new I.Index(t)
            }
            /*!
             * lunr.Builder
             * Copyright (C) 2020 Oliver Nightingale
            ...
            , I.Builder = function() {
                ...
                for (var e = {}, t = Object.keys(this.fieldTermFrequencies), r = t.length, n = Object.create(null), i = 0; i < r; i++) {
                    for (var s = I.FieldRef.fromString(t[i]), o = s.fieldName, a = this.fieldLengths[s], u = new I.Vector, l = this.fieldTermFrequencies[s], c = Object.keys(l), h = c.length, d = this._fields[o].boost || 1, f = this._documents[s.docRef].boost || 1, p = 0; p < h; p++) {
                        var y, m, g, x = c[p],
                            v = l[x],
                            w = this.invertedIndex[x]._index;
                        void 0 === n[x] ? (y = I.idf(this.invertedIndex[x], this.documentCount), n[x] = y) : y = n[x], m = y * ((this._k1 + 1) * v) / (this._k1 * (1 - this._b + this._b * (a / this.averageFieldLength[o])) + v), m *= d, m *= f, g = Math.round(1e3 * m) / 1e3, u.insert(w, g)
                    }
                    e[s] = u
                }
                this.fieldVectors = e
        ...
        constructor({
            ...
            this.documents = function(e) {
                const t = new Map,
                    r = new Set;
                for (const n of e) {
                    const [e, i] = n.location.split("#"), o = n.location, a = n.title, u = s(n.text).replace(/\s+(?=[,.:;!?])/g, "").replace(/\s+/g, " ");
                    if (i) {
                        const i = t.get(e);
                        r.has(i) ? t.set(o, {
                            location: o,
                ...
                return t
            }(t), this.highlight = function(e) {
                const t = new RegExp(e.separator, "img"),
                    r = (e, t, r) => `${t}<mark data-md-highlight>${r}</mark>`;
                return n => {
                    n = n.replace(/[\s*+\-:~^]+/g, " ").trim();
                    const i = new RegExp(`(^|${e.separator})(${n.replace(/[|\\{}()[\]^$+*?.-]/g,"\\$&").replace(t,"|")})`, "img");
                    return e => e.replace(i, r).replace(/<\/mark>(\s+)<mark[^>]*>/gim, "$1")
                }
            }(e), lunr.tokenizer.separator = new RegExp(e.separator), this.index = void 0 === n ? lunr((function() {
                1 === e.lang.length && "en" !== e.lang[0] ? this.use(lunr[e.lang[0]]) : e.lang.length > 1 && this.use(lunr.multiLanguage(...e.lang));
                const n = function(e, t) {
                    const [r, n] = [new Set(e), new Set(t)];
                    return [...new Set([...r].filter(e => !n.has(e)))]
                }(["trimmer", "stopWordFilter", "stemmer"], r);
                for (const t of e.lang.map(e => "en" === e ? lunr : lunr[e]))
                    for (const e of n) this.pipeline.remove(t[e]), this.searchPipeline.remove(t[e]);
                this.field("title", {
                    boost: 1e3
        ...
        search(e) {
            if (e) try {
                const t = this.highlight(e),
                    ...
                    }(e).filter(e => e.presence !== lunr.Query.presence.PROHIBITED);
                return [...this.index.search(e + "*").reduce((e, {
                    ref: n,
                    score: i,
                    matchData: s
                }) => {
                    ...
                    if (void 0 !== o) {
                        const {
                            ...
                            for (let e = 0; e < t.length; e++)
                                for (const i of r) t[e].startsWith(i.term) && (n[i.term] = !0, r.delete(i));
                            for (const e of r) n[e.term] = !1;
                            return n
                        }(r, Object.keys(s.metadata)), h = +!l + +Object.values(c).every(e => e);
                        e.push({
                            location: n,
                            title: t(a),
                            text: t(u),
                    ...
                    return e
                }, []).sort((e, t) => t.score - e.score).reduce((e, t) => {
            ...
            switch (e.type) {
                case i.SETUP:
                    return yield function(e) {
                        return n(this, void 0, void 0, (function*() {
                            let t = "../lunr";
                            if ("undefined" != typeof parent && "IFrameWorker" in parent) {
                                const e = document.querySelector("script[src]"),
                                    [r] = e.src.split("/worker");
                                t = t.replace("..", r)
                            }
                            const r = [];
                            for (const n of e.lang) "ja" === n && r.push(t + "/tinyseg.min.js"), "en" !== n && r.push(`${t}/min/lunr.${n}.min.js`);
                            e.lang.length > 1 && r.push(t + "/min/lunr.multi.min.js"), r.length && (yield importScripts(t + "/min/lunr.stemmer.support.min.js", ...r))
                        }))
                    }(e.data.config), a = new o(e.data), {
                        type: i.READY
                    };
                case i.QUERY:
                    return {
                        type: i.RESULT,
                        data: a ? a.search(e.data) : []
                    };
                default:
    ...
    }(i || (i = {})), addEventListener("message", e => n(void 0, void 0, void 0, (function*() {
